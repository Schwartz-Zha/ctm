...
CUDA_VISIBLE_DEVICES=0 mpiexec -n 1 python ./code/image_sample.py $MODEL_FLAGS --class_cond=True --num_classes=1000 --out_dir ./ctm-sample-paths/imagenet_authorckpt_50K/ --model_path=./ctm_pretrained/ema_0.999_049000.pt --training_mode=ctm --class_cond=True --eval_num_samples=50000 --batch_size=800 --device_id=0 --stochastic_seed=False --save_format=npz --ind_1=36 --ind_2=20 --use_MPI=True --sampler=exact --sampling_steps=1
