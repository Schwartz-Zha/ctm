#!/bin/bash
MODEL_FLAGS="--num_heun_step=17 --data_name=cifar10 --microbatch=128 --global_batch_size=512 --lr=0.0004 --class_cond=True --eval_interval=1000 --save_interval=1000 --num_classes=10 --eval_batch=250 --eval_fid=True --eval_similarity=False --check_dm_performance=False --log_interval=1"
