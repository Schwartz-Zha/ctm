#!/bin/bash
MODEL_FLAGS="--data_name=imagenet64 --microbatch=18 --global_batch_size=1440 --lr=0.0004 --class_cond=True --eval_interval=1000 --save_interval=1000 --num_classes=1000 --eval_batch=250 --eval_fid=True --eval_similarity=False --check_dm_performance=False --log_interval=1"
